...
then
	...
	echo ""
	echo "		For example: ./createDisk 100 osadaDisk.bin"
	echo ""
	echo "	This means that by default, this script will create and format with OSADA a 10MB disk, named disk.bin"
	echo ""
